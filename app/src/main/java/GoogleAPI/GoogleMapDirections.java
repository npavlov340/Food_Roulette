...
public class GoogleMapDirections
{
    ...
    public final static String API_KEY = "AIzaSyBE_Eb0a9kxHANigiyYhfkva2fnfLsYj2U";

    public void getDocument(LatLng start, LatLng end, DirectionsRunnable callback)
    {
        new DirectionsRequestAsyncTask(callback).execute(start, end);
       // return callback;
    }
